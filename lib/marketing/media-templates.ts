...
const POSTCARD_TEMPLATES: MediaTemplate[] = [
  {
    ...
    build: (c, v) =>
      doc("postcard-photo-hero", [
        ...
        ["paragraph", { content: c.tagline || c.excerpt, align: "left", color: "#e8ecf3", marginBottom: 16 }],
        [
          "button",
          {
...
const SOCIAL_TEMPLATES: MediaTemplate[] = [
  {
    ...
    build: (c, v) =>
      doc("social-photo", [
        ...
        ["paragraph", { content: c.tagline || c.excerpt, align: "left", color: "#e8ecf3", marginBottom: 18 }],
        [
          "button",
          {
            buttonText: "Give today",
