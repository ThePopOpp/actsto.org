/** Served from `public/actsto-logo-light.svg` — for light backgrounds (design-systems/logo_deck/actsto_logo_light.svg). */
export const ACT_LOGO_LIGHT = "/actsto-logo-light.svg";
...
/** Shepard AI agent mark — for dark backgrounds (design-systems/logo_deck/shepard_ai_dark_mode.svg). */
export const SHEPARD_ICON_DARK = "/shepard-ai-dark.svg";

/** Shepard AI agent mark — flat brand-red, theme-independent (design-systems/logo_deck/shepard_ai_red_mode.svg). */
export const SHEPARD_ICON_RED = "/shepard-ai-red.svg";
